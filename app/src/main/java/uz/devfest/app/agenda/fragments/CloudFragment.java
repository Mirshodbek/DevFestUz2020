...
import uz.devfest.app.firebasedatabasehelper.FirebaseDatabaseHelperCloud;
...
public class CloudFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new FirebaseDatabaseHelperCloud().readDevFestCloud(new FirebaseDatabaseHelperCloud.DataStatus() {
            @Override
