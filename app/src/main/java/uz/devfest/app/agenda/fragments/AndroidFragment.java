...
import uz.devfest.app.firebasedatabasehelper.FirebaseDatabaseHelperAndroid;
...
public class AndroidFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new FirebaseDatabaseHelperAndroid().readDevFestAndroid(new FirebaseDatabaseHelperAndroid.DataStatus() {
            @Override
