...
public class FirebaseDatabaseHelperCloud {
    ...
    public FirebaseDatabaseHelperCloud() {
        db = FirebaseDatabase.getInstance();
        query = db.getReference("sessions").orderByChild("cloudTime").endAt(7).limitToLast(7);
    }

    public void readDevFestCloud(final FirebaseDatabaseHelperCloud.DataStatus dataStatus) {
