...
import uz.devfest.app.firebasedatabasehelper.FirebaseDatabaseHelperSpeaker;
...
public class SpeakerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FirebaseDatabaseHelperSpeaker().readDevFest(new FirebaseDatabaseHelperSpeaker.DataStatus() {
            @Override
            public void DataIsLoaded(List<DevFest> devFest, List<String> keys) {
                progressBar = findViewById(R.id.progressBar);
                progressBar.setVisibility(View.GONE);
                new SpeakerAdapter().setConfig(mRecyclerView, SpeakerActivity.this, devFest, keys);
            }
        });
    }
